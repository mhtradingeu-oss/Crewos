...
// import { registerAutomationEngineSubscriber } from "../automation/engine/subscriber.js"; // Phase C.2: disabled
...
export function initEventHub() {
  ...
  // registerAutomationEngineSubscriber(); // Phase C.2: disabled
